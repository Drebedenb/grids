...
list_of_reviews = [
    {'id': 'review-1', 'author': 'Иван Семенович Г.', 'author_avatar': 'avatar19.jpg', 'project_photo': 'review1.jpg', 'description': 'Заказ №36378 Решетка на лоджию 3м2. Ответственные люди, я бы так назвал процесс взаимодействия с компанией. Все по плану, без заминок. Главное, что результат хороший и я им доволен.'},
    {'id': 'review-2', 'author': 'Янина Ш.', 'author_avatar': 'avatar25.jpg', 'project_photo': 'review2.jpg', 'description': 'Всем довольна, тамбурную решетчатую дверь мне варили и цветочницу. Прекрасно смотрятся в доме.. мастер позвонил перед выездом на замер. Цена устроила, состояние спустя год очень хорошее'},
    {'id': 'review-3', 'author': 'Иван Б.', 'author_avatar': 'avatar18.jpg', 'project_photo': 'review3.jpg', 'description': 'Заказал решетки ажурные на дачу в стиле кованых ворот. Можно было этого не делать, чуть скинув цену взять прямые. но мне так хотелось. по этому за саму работу мастеров и установщиков ставлю 5, а остальное уже история =В'},
    {'id': 'review-4', 'author': 'Александр В.', 'author_avatar': 'avatar14.jpg', 'project_photo': 'review4.jpeg', 'description': 'У меня все хорошо, ребята отлично работают. Знаю их завод под Клином, довольно дешево вышли металлические решетки на подвал и цоколь с установкой. Благодарю!'},
    {'id': 'review-5', 'author': 'Елена Б.', 'author_avatar': 'avatar17.jpg', 'project_photo': 'review5-1.jpg', 'description': 'Удобно и быстро! Нужны были решетки антикошка и защита от выпадения ребенка, я очень беспокойная мама)) Все супер, особенно общение по телефону и в мессенджерах с мастерами. Так держать, обращусь к вам еще, как куплю дачу'},
    {'id': 'review-6', 'author': 'Кирилл П.', 'author_avatar': 'avatar3.jpg', 'project_photo': 'review6.jpeg', 'description': 'Выражаем свою благодарность слаженной работе мастеров ООО «Оконные решётки» за высокое качество изготовления решеток для организации и их установку. Компания обладает профессионализмом и рекомендует себя как надежного подрядчика в вопросе металлических решеток. С уважением, коллектив ХозМастер - Первый.'},
    {'id': 'review-7', 'author': 'Марина Г.', 'author_avatar': 'avatar9.jpg', 'project_photo': 'review7.jpeg', 'description': 'Решетки с защитой от детей, от их выпадания мне сделали за 2 дня и привезли домой'},
    {'id': 'review-8', 'author': 'Светлана К.', 'author_avatar': 'avatar24.jpg', 'project_photo': 'review8.jpg', 'description': 'Обратились с запросом решетчатой двери и решеток в магазин. Искали решетки для бизнеса. поставили в срок'},
    {'id': 'review-9', 'author': 'Сергей Н.', 'author_avatar': 'avatar12.jpg', 'project_photo': 'review9.jpeg', 'description': 'Как хочется чтобы все в жизни было так же быстро и четко. я НЕ участвовал ни в одном вопросе в моменте производства решеток на окна в дом, ни на моменте их установки. Действительно компания-молодец! Выбрал, заказал, оплатил - привезли'},
    {'id': 'review-10', 'author': 'Лариса Ивановна Л.', 'author_avatar': 'avatar20.jpg', 'project_photo': 'review10.jpeg', 'description': 'Раньше сталкивалась с частниками в вопросе стройки- ремонта и боялась столкнуться с ними в выборе оконной решетки на дачу. Совершенно мне этого не хотелось, поэтому сразу искала компанию с опытом, гарантией, договором, точной ценой и без обмана. Также не хотелось долго объяснять все на пальцах по телефону, как обычно с частниками без сайтов происходит.По итогу ни разу не пожалела, что обратилась в вашу компанию. Вы меня прямо спасли от нечестных цен и буквально руководства людьми на объекте. Всем советую, получила идеальную цену/качество'},
    {'id': 'review-11', 'author': 'Галина У.', 'author_avatar': 'avatar7.jpg', 'project_photo': 'review11.jpg', 'description': 'Я далека от строительства, поэтому долго расспрашивала знакомых и искала в интернете информацию про решетки на окна в квартиру. По итогу больше всего мне впечатлили отзывы о фирме “Оконные решетки”, сразу было видно, что они давно на рынке и имеют опыт работы. Я не ошиблась) Привлекло также собственное производство, потому что у меня в апартаментах нестандартного размера окна, а хотелось не тянуть с процессом и поскорее сделать на заказ. Общением с компанией довольна, все рассказали детально, ответили на все мои вопросы, и самое главное, что со мной общались на моем языке без погружения в терминологиюХочу сказать спасибо, сделали все очень качественно, мне не к чему придраться. Нужно было установить решетки на окна 40 на 23 и решетку для кондиционера, все сделали за 3 дня с учетом изготовления.'},
    {'id': 'review-12', 'author': 'Антонина И.', 'author_avatar': 'avatar2.jpg', 'project_photo': 'review13.jpeg', 'description': 'Компанию посоветовал коллега для установки решеток на приямки и решетки для бизнеса в целом. У нас офисное здание и искали надежного подрядчика в этой сфере. С уверенностью могу сказать, что компания себя зарекомендовала с отличной стороны. Из перечня работ было изготовление: сварные решетки на окна 30 штук, решетчатые двери внутренние 4 штуки, решетки на кондиционер 5 штук, решетки на приямки 17 штук. '}
]

list_of_reviews_collapsed = [
    {'id': 'review-13', 'author': 'Андрей Алексеевич Б.', 'author_avatar': 'avatar15.jpg', 'project_photo': 'review14.jpg', 'description': 'Заказывал кованые решетки себе на дачу. Очень крепкие, безопасность чувствуется сразу, а главное - красивые, соседи обзавидовались. Быстро и качественно установили, всем советую!'},
    {'id': 'review-14', 'author': 'Алексей Р.', 'author_avatar': 'avatar26.png', 'project_photo': 'review6.jpeg', 'description': 'Я заказал оконные решетки для моего небольшого антикварного магазина на цокольном этаже. Проблема была в том, что окошки маленькие и не представлял как бы сделать их еще и красивыми. Для меня подготовили эскизы кованых решеток, которые прекрасно вписались в тематику моего магазина. После их установки решил заказать и решетчатые двери на вход. Доволен на 100%! Безопасность и красота одновременно. Большое спасибо за индивидуальный подход'},
    {'id': 'review-15', 'author': 'Нина С.', 'author_avatar': 'avatar30.png', 'project_photo': 'review7.jpeg', 'description': 'Решили украсить офис, как только началась весна. Заказали цветочницы, но хотели уложиться в свой бюджет. Нам предложили разные опции и смогли подобрать подходящий вариант по цене и по виду. Через пару дней уже приехали установщики, быстро все поставили, даже до обеда успели. Теперь всем коллективом приносим цветочки из дома, окна радуют глаз. Спасибо за оперативность и качество!'},
    {'id': 'review-16', 'author': 'Надежда С.', 'author_avatar': 'avatar23.jpg', 'project_photo': 'review19.jpeg', 'description': 'Бесконечно можно смотреть на три вещи: на горящий огонь, на текущую воду и на кованые решетки у меня на даче. Большое спасибо, Вы мастера своего дела!!'},
    {'id': 'review-17', 'author': 'Мария У.', 'author_avatar': 'avatar27.png', 'project_photo': 'review25.jpg', 'description': 'На первый этаж квартиры заказала решетки на окна, но хотела что-то более минималистичное, потому что живу в новостройке.Замерщик предложил много вариантов для меня и через три дня уже приехали устанавливать. Просто и со вкусом, как и хотела, спасибо!'},
    {'id': 'review-18', 'author': 'Георгий Р.', 'author_avatar': 'avatar28.jpg', 'project_photo': 'review26.jpg', 'description': 'Замерять приехали в удобное мне время, за это спасибо. Опытные сотрудники, сразу это заметил. Четко и быстро, я доволен.  '},
    {'id': 'review-19', 'author': 'Наталья М.', 'author_avatar': 'avatar32.png', 'project_photo': 'review30.jpg', 'description': 'Собрались с мужем лететь в отпуск и нужно было быстро установить решетки на окна из соображений безопасности. С работой справились за пару дней и даже скидку сделали за большой заказ, т.к. дом немаленький. Решетки красивые и надежные, благодарим за срочность выполнения.'},
    {'id': 'review-20', 'author': 'Алексей Сергеевич С..', 'author_avatar': 'avatar33.png', 'project_photo': 'review33.jpg', 'description': 'Замерили и установили дутые решетки на окна. Боялся, что может выйти так себе, но получилось очень красиво. Переживал за бюджет, но заказ вышел по карману. Не стыдно рекомендовать, спасибо!'},
    {'id': 'review-21', 'author': 'Андрей Н', 'author_avatar': 'avatar34.png', 'project_photo': 'review36.jpg', 'description': 'Фирма очень ответственная. Поставили классические решетки на окна, упор при заказе ставил на прочность. Вышли настолько крепкими, что кажутся крепче самих стен)). Монтаж как по маслу, спасибо Вам.'},
    {'id': 'review-22', 'author': 'Василий Щ', 'author_avatar': 'avatar35.png', 'project_photo': 'review39.jpg', 'description': 'Недавно заказал металлические решетки на окна этой компании и остался под впечатлением! Высокое качество и шикарный внешний вид. Всегда поражало то, как умельцы работают с металлом. Спасибо за вам за такую красоту!'},
    {'id': 'review-23', 'author': 'Любовь Г.', 'author_avatar': 'avatar36.png', 'project_photo': 'review1.jpg', 'description': 'На прошлой неделе заказала цветочницу для дачи. Крепкая и, как говорится, "на века". Теперь она стала новым украшением нашего дома, а ещё в ней классно смотрятся все цветочные горшки. В общем, превзошли мои ожидания и порадовали ценой.  '},
    {'id': 'review-24', 'author': 'Роман К.', 'author_avatar': 'avatar37.png', 'project_photo': 'review44.jpeg', 'description': 'У меня есть небольшой продуктовый магазинчик и недавно решил заказать решетчатые двери для склада. Выглядят надежно и кстати пропускают много света, это + к экономии. Сориентировали по выбору и быстро установили. Рекомендую фирму любому владельцу бизнеса, которого интересует и безопасность и внешний вид своего предприятия.'},
    {'id': 'review-25', 'author': 'Екатерина А.', 'author_avatar': 'avatar38.png', 'project_photo': 'review41.jpg', 'description': 'Если у вас есть кошки и вы беспокоитесь, что ваши пушистики выпрыгнут за птичками, играя на подоконнике, я рекомендую выбрать решетку антикошку. Ребята быстро ее установили и теперь я спокойна за этих хвостатых охотниц. Мне предложили много вариантов по размерам, отлично все подобрали. Если хотите крепко спать, зная что ваши кошки в безопасности, то заказывайте решетку этой фирмы!'},
    {'id': 'review-26', 'author': 'Даниил Л.', 'author_avatar': 'avatar39.png', 'project_photo': 'review42.jpeg', 'description': 'Недавно закончил с балконом и хотел решить вопрос безопасности, не портя его внешний вид. Друг посоветовал эту фирму. Вопрос решили за пару дней, решетка выглядит шикарно и самое главное - надежно. Порадовала работа установщиков и сроки выполнения работ. Спасибо!'},
    {'id': 'review-27', 'author': 'Анастасия И.', 'author_avatar': 'avatar40.JPG', 'project_photo': 'review41.jpg', 'description': 'Как директор офиса расположенного в старинном здании, я была обеспокоена как безопасностью, так и внешним видом наших окон. В интернете нашла эту компанию, позвонила и девушки менеджеры завоевали мое сердце. Подобрали специально для нас эскизы и оформили установку. Я в восторге от результата - конструкция не только обеспечивает необходимую нам безопасность, но и прекрасно дополняет архитектурный стиль здания прошлого века. Весь отдел доволен тем, как они выглядят, и мне больше не нужно беспокоиться о безопасности офиса. Спасибо за отлично выполненную работу!'},
    {'id': 'review-28', 'author': 'Иван Ж.', 'author_avatar': 'avatar41.png', 'project_photo': 'review1.jpg', 'description': 'Жена любит возиться с цветами, поэтому захотел сделать ей подарок на юбилей. Заказал цветочницы на окна, а на днях их уже установили. Я в этом ничего не понимаю, но по телефону мне помогли с выбором и сделали скидку. Жена безумно рада, теперь вся зелень красуется на окнах. Спасибо вам огромное'},
    {'id': 'review-29', 'author': 'Клим П.', 'author_avatar': 'avatar42.png', 'project_photo': 'review41.jpg', 'description': 'Срочно заказывал решетки на подвал. Всё ок, быстро и четко. Даже мышь не пролезет'},
    {'id': 'review-30', 'author': 'Николай Ш.', 'author_avatar': 'avatar43.png', 'project_photo': 'review41.jpg', 'description': 'Мы учительским советом решили заказать нашим детям в школу решетчатые двери на спортзал и столовку, потому что уже нет надежды, что старые тоненькие дверки выдержат. Удивило то, что цена совсем не кусается и всё вышло нам по карману. Дети теперь не снесут старые двери толпой, а мы будем спокойны. Большое вам спасибо, всё сделали быстро и профессионально'},
