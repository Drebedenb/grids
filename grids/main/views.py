...
ALL_CITIES = {
'решетки-на-окна-в-твери': {'title': 'Тверь', 'address': '', 'text': ''},
'решетки-на-окна-в-балашихе': {'title': 'Балашиха', 'address': '', 'text': ''},
'решетки-на-окна-в-химках': {'title': 'Химки', 'address': '', 'text': ''},
'решетки-на-окна-в-мытищах': {'title': 'Мытищи', 'address': '', 'text': ''},
'решетки-на-окна-в-люберцах': {'title': 'Люберцы', 'address': '', 'text': ''},
'решетки-на-окна-в-подольске': {'title': 'Подольск', 'address': '', 'text': ''},
'решетки-на-окна-в-красногорске': {'title': 'Красногорск', 'address': '', 'text': ''},
'решетки-на-окна-в-одинцово': {'title': 'Одинцово', 'address': '', 'text': ''},
'решетки-на-окна-в-королеве': {'title': 'Королёв', 'address': '', 'text': ''},
'решетки-на-окна-в-пушкино': {'title': 'Пушкино', 'address': '', 'text': ''},
'решетки-на-окна-в-орехово-зуево': {'title': 'Орехово-Зуево', 'address': '', 'text': ''},
'решетки-на-окна-в-клину': {'title': 'Клин', 'address': '', 'text': ''},
'решетки-на-окна-в-долгопрудном': {'title': 'Долгопрудный', 'address': '', 'text': ''},
'решетки-на-окна-в-щелково': {'title': 'Щёлково', 'address': '', 'text': ''},
'решетки-на-окна-в-домодедово': {'title': 'Домодедово', 'address': '', 'text': ''},
'решетки-на-окна-в-серпухове': {'title': 'Серпухов', 'address': '', 'text': ''},
'решетки-на-окна-в-зеленограде': {'title': 'Зеленоград', 'address': '', 'text': ''},
'решетки-на-окна-в-коломне': {'title': 'Коломна', 'address': '', 'text': ''},
'решетки-на-окна-в-раменском': {'title': 'Раменское', 'address': '', 'text': ''},
'решетки-на-окна-в-сергиев-посаде': {'title': 'Сергиев-Посад', 'address': '', 'text': ''},
'решетки-на-окна-в-реутове': {'title': 'Реутов', 'address': '', 'text': ''},
'решетки-на-окна-в-электростали': {'title': 'Электросталь', 'address': '', 'text': ''},
'решетки-на-окна-в-жуковском': {'title': 'Жуковский', 'address': '', 'text': ''},
'решетки-на-окна-в-лобне': {'title': 'Лобня', 'address': '', 'text': ''},
'решетки-на-окна-в-ивантеевке': {'title': 'Ивантеевка', 'address': '', 'text': ''},
'решетки-на-окна-в-видном': {'title': 'Видное', 'address': '', 'text': ''},
'решетки-на-окна-в-воскресенске': {'title': 'Воскресенск', 'address': '', 'text': ''},
'решетки-на-окна-в-ногинске': {'title': 'Ногинск', 'address': '', 'text': ''},
'решетки-на-окна-в-ступино': {'title': 'Ступино', 'address': '', 'text': ''},
'решетки-на-окна-в-дзержинском': {'title': 'Дзержинский', 'address': '', 'text': ''},
'решетки-на-окна-в-солнечногорске': {'title': 'Солнечногорск', 'address': '', 'text': ''},
'решетки-на-окна-в-дмитрове': {'title': 'Дмитров', 'address': '', 'text': ''},
'решетки-на-окна-в-лыткарино': {'title': 'Лыткарино', 'address': '', 'text': ''},
'решетки-на-окна-в-дедовске': {'title': 'Дедовск', 'address': '', 'text': ''},
'решетки-на-окна-в-хотьково': {'title': 'Хотьково', 'address': '', 'text': ''},
'решетки-на-окна-в-железнодорожном': {'title': 'Железнодорожный', 'address': '', 'text': ''},
'решетки-на-окна-в-дубне': {'title': 'Дубна', 'address': '', 'text': ''},
'решетки-на-окна-в-чехове': {'title': 'Чехов', 'address': '', 'text': ''},
'решетки-на-окна-в-фрязино': {'title': 'Фрязино', 'address': '', 'text': ''},
'решетки-на-окна-в-лосино-петровском': {'title': 'Лосино-Петровский', 'address': '', 'text': ''},
'решетки-на-окна-в-павловском-посаде': {'title': 'Павловский посад', 'address': '', 'text': ''} ,
'решетки-на-окна-в-краснознаменске': {'title': 'Краснознаменск', 'address': '', 'text': ''},
'решетки-на-окна-в-звенигороде': {'title': 'Звенигород', 'address': '', 'text': ''},
'решетки-на-окна-в-старой-купавне': {'title': 'Старая Купавна', 'address': '', 'text': ''} ,
'решетки-на-окна-в-электрогорске': {'title': 'Электрогорск', 'address': '', 'text': ''},
'решетки-на-окна-в-апрелевке': {'title': 'Апрелевка', 'address': '', 'text': ''},
'решетки-на-окна-в-троицке': {'title': 'Троицк', 'address': '', 'text': ''},
'решетки-на-окна-в-щербинке': {'title': 'Щербинка', 'address': '', 'text': ''},
'решетки-на-окна-в-пущино': {'title': 'Пущино', 'address': '', 'text': ''},
'решетки-на-окна-в-можайске': {'title': 'Можайск', 'address': '', 'text': ''},
'решетки-на-окна-в-черноголовке': {'title': 'Черноголовка', 'address': '', 'text': ''},
'решетки-на-окна-в-голицыно': {'title': 'Голицыно', 'address': '', 'text': ''},
'решетки-на-окна-в-кашире': {'title': 'Кашира', 'address': '', 'text': ''},
'решетки-на-окна-в-истре': {'title': 'Истра', 'address': '', 'text': ''},
'решетки-на-окна-в-электроуглях': {'title': 'Электроугли', 'address': '', 'text': ''},
'решетки-на-окна-в-егорьевске': {'title': 'Егорьевск', 'address': '', 'text': ''},
'решетки-на-окна-в-протвино': {'title': 'Протвино', 'address': '', 'text': ''},
'решетки-на-окна-в-наро-фоминске': {'title': 'Наро-Фоминск', 'address': '', 'text': ''},
'решетки-на-окна-в-луховицах': {'title': 'Луховицы', 'address': '', 'text': ''},
'решетки-на-окна-в-шатуре': {'title': 'Шатура', 'address': '', 'text': ''},
'решетки-на-окна-в-волоколамске': {'title': 'Волоколамск', 'address': '', 'text': ''},
'решетки-на-окна-в-кубинке': {'title': 'Кубинка', 'address': '', 'text': ''},
'решетки-на-окна-в-бронницах': {'title': 'Бронницы', 'address': '', 'text': ''},
'решетки-на-окна-в-зарайске': {'title': 'Зарайск', 'address': '', 'text': ''},
'решетки-на-окна-в-рузе': {'title': 'Руза', 'address': '', 'text': ''},
'решетки-на-окна-в-красноармейске': {'title': 'Красноармейск', 'address': '', 'text': ''},
'решетки-на-окна-в-пересвете': {'title': 'Пересвет', 'address': '', 'text': ''},
'решетки-на-окна-в-котельниках': {'title': 'Котельники', 'address': '', 'text': ''},
'решетки-на-окна-в-московском': {'title': 'Московский', 'address': '', 'text': ''},
'решетки-на-окна-в-климовске': {'title': 'Климовск', 'address': '', 'text': ''},
'решетки-на-окна-в-ликино-дулево': {'title': 'Ликино-Дулёво', 'address': '', 'text': ''},
'решетки-на-окна-в-озерах': {'title': 'Озёры', 'address': '', 'text': ''},
'решетки-на-окна-в-купавне': {'title': 'Купавна', 'address': '', 'text': ''},
'решетки-на-окна-в-рошали': {'title': 'Рошаль', 'address': '', 'text': ''},
'решетки-на-окна-в-куровском': {'title': 'Куровское', 'address': '', 'text': ''},
'решетки-на-окна-в-талдоме': {'title': 'Талдом', 'address': '', 'text': ''},
'решетки-на-окна-в-краснозаводске': {'title': 'Краснозаводск', 'address': '', 'text': ''},
'решетки-на-окна-в-яхроме': {'title': 'Яхрома', 'address': '', 'text': ''},
'решетки-на-окна-в-высоковске': {'title': 'Высоковск', 'address': '', 'text': ''},
'решетки-на-окна-в-дрезне': {'title': 'Дрезна', 'address': '', 'text': ''},
'решетки-на-окна-в-верее': {'title': 'Верея', 'address': '', 'text': ''},
}
...
def catalog_category(request, category_name):
    category = {}
    if category_name in russian_categories:
        category = russian_categories[category_name]
    elif category_name in ALL_CITIES:
        category = ALL_CITIES[category_name]
        category["number_of_category"] = ALL_CATEGORIES
        category["text"] = 'cities/' + category_name + '.html'
        category["title"] = 'Решетки в городе ' +  category["title"]
    else:
